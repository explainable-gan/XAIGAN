...
def calculate_fid_given_paths(paths, cuda=False, dims=2048, bootstrap=True, n_bootstraps=10, model_type='lenet', batch_size=50):
...
if __name__ == '__main__':
    ...
    results = calculate_fid_given_paths(paths, args.batch_size, False, args.dims, model_type=args.model)
