...
def _compute_activations(path, model, batch_size, dims, model_type):
...
def calculate_kid_given_paths(paths, batch_size=50, dims=2048, model_type='lenet'):
...
if __name__ == '__main__':
    ...
    results = calculate_kid_given_paths(paths, batch_size=args.batch_size, dims=args.dims, model_type=args.model)
